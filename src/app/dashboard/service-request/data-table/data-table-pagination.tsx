...
import { RequestParameterType, updateRequestParameter } from "@/app/redux/slices/filteration.slice"
...
export function DataTablePagination<TData>({
  ...
  const [parameter,setParameter] = useState<RequestParameterType>({
    limit:10,
    page:1,
  })
  const dispatch = useDispatch();
  useEffect(()=>{
   dispatch(updateRequestParameter(parameter))
  },[parameter])
  return (

...
interface ManuallyFunctionProp{
  catId:string
}

function AddServicesManually({catId}:ManuallyFunctionProp) {
  ...
  const onSubmit: SubmitHandler<FormData> = async (data) => {
    ...
    try {
     ...
     if(res.status===200){
      ...
      toast({
        title: res.data?.success||"SUCCESS",
        description: res.data.message||"SUCCESSFULLY CREATED SERVICE",
        variant: "success",
        duration: 2000,
  ...
  return (
    ...
    <Card className=" w-full">
       <CardHeader>
        ...
        <CardDescription>Create your new service.</CardDescription>
      </CardHeader>
